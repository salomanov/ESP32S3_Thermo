...
def publish_calibrate_minute()
    var temp = persist.latest_temp
    if temp != nil && persist.calibrate_temp != temp
...
tasmota.add_rule("Time#Minute", publish_calibrate_minute, "publish_calibrate_minute")
